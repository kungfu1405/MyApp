#pragma checksum "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d62f9226d26e6bb552334d053bf65b6b6da04012"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Shared__EditSession), @"mvc.1.0.view", @"/Views/Shared/_EditSession.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d62f9226d26e6bb552334d053bf65b6b6da04012", @"/Views/Shared/_EditSession.cshtml")]
    ...
    public class Views_Shared__EditSession : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral(@"<div class=""modal fade"" id=""modal-edit"" aria-hidden=""true"">
  ...
  ");
            WriteLiteral(@"                  </div>
                ...
                <div class=""card-footer"" style=""overflow: hidden;"">
                    <label class=""txtStt_edit"" style=""float: left;");
            WriteLiteral(@"""></label>
...
<script type=""text/javascript"">
    function addSession(obj) {
        ...
        var checkAdd = true;
        ");
            WriteLiteral(@"$(""input.upload-input"").each(function (index, input) {
            if ($(input).val() == """") {
                checkAdd = false;
                $(input).focus();
            ...
            <form id=""frmUpload_`+ count +`"">
                <div class=""card-body"">
                    ...
                    <div class=""form-group row"">
                        <div class=""col-sm-12 col-lg-6 col-md-6  my-select2"">
                ");
            WriteLiteral(@"            <select class=""form-control"" id=""mySelect2_`+ count +`_destination""></select>
                        </div>
                    ...
                    <div class=""form-group dropzone row dropzone-box dropzone-box_1 dropzone-preview-`+ count +`"" style=""padding-left: 15px;"">
                      ...
                      ");
            WriteLiteral(@"          <div class=""dropzone-msg dz-message needsclick"">
                                    <h3 class=""dropzone-msg-title"">+ Add Photos</h3>
                                </div>
                            </div>
                        </div>
        ...
        $(""#"" + id).dropzone({
            url: """);
#nullable restore
#line 119 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
...
#nullable disable
        ...
        $(""#mySelect2_"" + count + ""_destination"").select2({
            ...
            allowClear: true,
 ");
            WriteLiteral("           placeholder: \'Pin To Your Destination\',\r\n            ajax: {\r\n                url: \'");
#nullable restore
#line 150 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
...
#nullable disable
        ...
        $(""#mySelect2_""+ count +""_attraction"").select2({
            ...
            ajax: {
                url: '");
#nullable restore
#line 174 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
...
#nullable disable
    ...
    function checkText(obj) {
        ...
        {
  ");
            WriteLiteral(@"          btn.removeClass(""active"");
            return;
        }
    ...
    function notifi(type, mess) {
        ...
        if (type == ""success"") {
            ...
            ");
            WriteLiteral(@"className = ""text-danger"";
        }
        else {
...
#nullable restore
#line 269 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
                                                        Write(UrlList.FileServer);

#line default
#line hidden
#nullable disable
            WriteLiteral("`+ thumb[j].imagerUrl + `\">\r\n                        </div>`;\r\n                else\r\n                    exImg += `<div class=\"carousel-item\">\r\n                            <img class=\"d-block w-100\" src=\"");
#nullable restore
#line 273 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
                                                        Write(UrlList.FileServer);
...
#nullable disable
            ...
            exImg += `<img style=""margin-bottom: 5px;"" src=""");
#nullable restore
#line 288 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
                                                        Write(UrlList.FileServer);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"` + thumb[0].imagerUrl + `"">`;
        }
        ...
        if (document.getElementById(id)) {
            $(""main.ma");
            WriteLiteral(@"in-content"").find(""#"" + id).replaceWith(temp);
        }
        else {
    ...
    function checkNumSection() {
        ...
        if (listItem.length > 1) {
            ...
            $("".addBtn");
            WriteLiteral(@""").attr(""data-sess"", (listItem.length - 1));
        }
    }
    ...
    function editSession(id, _this) {
        ...
        if (flgEdit == 0) {
            ...
            $('#kt_dropzone_edit').each(function () {
                ...
                let dropzoneControl ");
            WriteLiteral("= $(this)[0].dropzone;\r\n                if (dropzoneControl) {\r\n                    dropzoneControl.destroy();\r\n                }\r\n            });\r\n\r\n            var myDropzoneEdit = new Dropzone(\"#kt_dropzone_edit\", {\r\n                url: \"");
#nullable restore
#line 388 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
                  Write(string.Format("{0}/api/file/upload", UrlList.FileServer));
            ...
            WriteLiteral(@"reload)
                ...
                myDropzoneEdit.processQueue();
                    $.ajax({
                        url: """);
#nullable restore
#line 427 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
                          Write(string.Format("{0}/api/file/upload", UrlList.FileServer));
...
#nullable disable
            ...
            $(""#edited_destination"").select2({
                minimu");
            WriteLiteral("mInputLength: 2,\r\n                allowClear: true,\r\n                placeholder: \'Pin to your Destination\',\r\n                ajax: {\r\n                    url: \'");
#nullable restore
#line 461 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
...
#nullable disable
            ...
            $(""#edited_attraction"").select2({
                ...
                ajax: {
                    url: '");
#nullable restore
#line 485 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
                     Write(Url.Action("Search", "Attraction"));
...
#nullable disable
            ...
            $.ajax({
                ...
                success: function (data) {
                    $(""#edit_");
            WriteLiteral(@"title"").val(data.experience.title);
                    ...
                    if (data.experience.images.length > 0) {
                        ...
                        for (var i = 0; i < data.experience.images.length; i++) {
                            var mockFile = {
                                ...
                                url: """);
#nullable restore
#line 521 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
                                  Write(UrlList.FileServer);

#line default
#line hidden
#nullable disable
            WriteLiteral(@""" + data.experience.images[i].imagerUrl,
                                preload: true
                            };
                            ...
                            myDropzoneEdit.emit(""thumbnail"", mockFile, """);
#nullable restore
#line 529 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
                                                                    Write(UrlList.FileServer);
...
#nullable restore
#line 532 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
                                        Write(UrlList.FileServer);
...
#nullable disable
            WriteLiteral(@""" + data.experience.images[i].imagerUrl);
                            ...
                            if (data.destination.id != undefined && data.destination.id != null) {
                              ...
                              ");
            WriteLiteral(@"  var newDesOption = new Option(dataDesSelected.text, dataDesSelected.id, false, false);
    ...
    ");
            WriteLiteral(@"            errMess = ""Please Select Any File!"";
            }
            ...
            $.ajax({
                ...
                success: function (data, textStatus, xhr) {
          ");
            WriteLiteral(@"          //myDropzoneEdit.removeAllFiles(true);
                    $(""#edit_title"").val('');
                    quillEdit.setText('');
    ...
    function uploadSection(obj) {
        ...
        //console.log(parent);
    ");
            WriteLiteral(@"    var imgs = parent.find(""img"");
        ...
        $.each(imgs, function (i, file) {
            ...
            //dataFr.append('file', dataURItoBlob(file.currentSrc, file.al");
            WriteLiteral("t));\r\n        });\r\n        //console.log(imgs);return;\r\n        $.ajax({\r\n            url: \"");
#nullable restore
#line 726 "E:\Microtec\Project\travel-hub\svn\4.WebFrontend\Web.Frontend\Views\Shared\_EditSession.cshtml"
              Write(string.Format("{0}/api/file/upload", UrlList.FileServer));
            ...
            success: function (response, textStatus, xhr) {
                if (response.length > 0) {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function () {
                            //$("".txtStt_Upload"").removeClass(""text-danger"").removeClass(""text-success"").empty().html(""Uploading ..."");
                            parent.find("".btnUploadSection"").css(");
...
");
    ...
    function dataURLtoFile(dataurl, filename) {
        var arr = dataurl.split(','), mime = arr[0].match(/:(.*?);/)[1],
            bstr = atob(arr[1");
            WriteLiteral(@"]), n = bstr.length, u8arr = new Uint8Array(n);
        while (n--) {
    ...
    function dataURItoBlob(dataURI, fileName) {
        ...
        // writ");
            WriteLiteral(@"e the bytes of the string to a typed array
