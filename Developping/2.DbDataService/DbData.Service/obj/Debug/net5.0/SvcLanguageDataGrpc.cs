...
namespace UserDb.Protos {
  ...
  public static partial class LanguageDataServices
  {
    ...
    /// <summary>Base class for server-side implementations of LanguageDataServices</summary>
    [grpc::BindServiceMethod(typeof(LanguageDataServices), "BindService")]
    public abstract partial class LanguageDataServicesBase
    {
      ...
      public virtual global::System.Threading.Tasks.Task<global::DbData.Protos.ResponseMessage> Edit(global::UserDb.Protos.LanguageDataStruct request, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public static grpc::ServerServiceDefinition BindService(LanguageDataServicesBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    public static void BindService(grpc::ServiceBinderBase serviceBinder, LanguageDataServicesBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_Edit, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::UserDb.Protos.LanguageDataStruct, global::DbData.Protos.ResponseMessage>(serviceImpl.Edit));
