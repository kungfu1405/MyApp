...
namespace UserDb.Protos {
  ...
  public static partial class LanguageDataLocalServices
  {
    ...
    /// <summary>Client for LanguageDataLocalServices</summary>
    public partial class LanguageDataLocalServicesClient : grpc::ClientBase<LanguageDataLocalServicesClient>
    {
      /// <summary>Creates a new client for LanguageDataLocalServices</summary>
      /// <param name="channel">The channel to use to make remote calls.</param>
      public LanguageDataLocalServicesClient(grpc::ChannelBase channel) : base(channel)
      {
      }
      /// <summary>Creates a new client for LanguageDataLocalServices that uses a custom <c>CallInvoker</c>.</summary>
      /// <param name="callInvoker">The callInvoker to use to make remote calls.</param>
      public LanguageDataLocalServicesClient(grpc::CallInvoker callInvoker) : base(callInvoker)
      {
      }
      /// <summary>Protected parameterless constructor to allow creation of test doubles.</summary>
      protected LanguageDataLocalServicesClient() : base()
      {
      }
      /// <summary>Protected constructor to allow creation of configured clients.</summary>
      /// <param name="configuration">The client configuration.</param>
      protected LanguageDataLocalServicesClient(ClientBaseConfiguration configuration) : base(configuration)
      {
      }
      ...
      protected override LanguageDataLocalServicesClient NewInstance(ClientBaseConfiguration configuration)
      {
        return new LanguageDataLocalServicesClient(configuration);
      }
    }
