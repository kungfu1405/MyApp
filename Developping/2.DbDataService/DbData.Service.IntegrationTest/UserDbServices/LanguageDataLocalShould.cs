...
using static UserDb.Protos.LanguageDataLocalServices;
...
namespace DbData.Service.IntegrationTest.UserDbServices
{
    ...
    public class LanguageDataLocalShould
    {
        private readonly LanguageDataLocalServicesClient client;
        private readonly LanguageServicesClient languageClient;
        private static string langCode;
        private static string langKey;

        public LanguageDataLocalShould(TestServerHosting server)
        {
            client = new LanguageDataLocalServicesClient(server.GrpcChannel);
